...
export default function SuryaMark({ size = 40, className = "", title }) {
  ...
  return (
    ...
    >
      ...
      <path d="M9.5 33.7C15.4 25.9 24.4 22.2 38.5 23.4C37.1 33.2 30.4 39.4 20.8 39.4C16.2 39.4 12.4 37.4 9.5 33.7Z" fill={`url(#${leafId})`} />
      <path d="M11.6 37.4C17.7 31.5 24.9 27.7 34.8 25.4" stroke="#F4F1D0" strokeWidth="2.35" strokeLinecap="round" />
