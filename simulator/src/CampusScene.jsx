...
const VIT_ROOFTOP_VAWT_GROUPS = [
  // Academic Blocks 1 and 2 intentionally have no wind turbines.
  { id: "girls-1", position: [-40, 22.95, -115], width: 54, depth: 12, count: 3, rows: 1, scale: 0.94 },
  ...
  { id: "chancellor-south-east", position: [29.8, 30.15, -96.2], width: 15, depth: 12, count: 1, scale: 0.76 },
  { id: "chancellor-south-west", position: [78.2, 25.75, -96.2], width: 13, depth: 12, count: 1, scale: 0.76 },
  { id: "girls-2", position: [-180, 21.4, -42], width: 110, depth: 14, count: 3, rows: 1, scale: 0.9 },
  { id: "boys-1", position: [-520, 25.95, -88], width: 84, depth: 15, count: 3, rows: 1, scale: 0.98 },
  ...
  { id: "modern-hostel", position: [-520, 28.55, -370], width: 72, depth: 15, count: 3, rows: 1, scale: 0.98 },
  { id: "boys-mess", position: [-450, 10.4, -270], width: 34, depth: 12, count: 3, rows: 1, scale: 0.88 },
  // The Lab is L-shaped, so each leg gets its own compact roof array.
  { id: "labs-east-west", position: [123, 13.35, 155], width: 28, depth: 13, count: 2, rows: 1, scale: 0.9 },
  { id: "labs-north-south", position: [136, 13.35, 130], width: 12, depth: 27, count: 1, scale: 0.9 },
  { id: "architecture", position: [129, 13.35, 96], width: 32, depth: 12, count: 3, rows: 1, scale: 0.9 },
  ...
  { id: "hall-west-roof", position: [212.7, 14.55, -43], width: 8, depth: 32, count: 2, rows: 2, scale: 0.86 },
  { id: "hall-east-roof", position: [231.3, 14.55, -43], width: 8, depth: 32, count: 1, scale: 0.86 },
